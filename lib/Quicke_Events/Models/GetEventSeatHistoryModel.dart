...
List<GetEventSeatHistoryModel> getEventSeatHistoryModelFromJson(String str) => List<GetEventSeatHistoryModel>.from(json.decode(str).map((x) => GetEventSeatHistoryModel.fromJson(x)));

String getEventSeatHistoryModelToJson(List<GetEventSeatHistoryModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class GetEventSeatHistoryModel {
    ...
    factory GetEventSeatHistoryModel.fromJson(Map<String, dynamic> json) => GetEventSeatHistoryModel(
        id: json["id"],
