...
class ExploreNearByEventsScreen extends StatefulWidget {
  const ExploreNearByEventsScreen({super.key});

  @override
  State<ExploreNearByEventsScreen> createState() => _ExploreNearByEventsScreenState();
}

class _ExploreNearByEventsScreenState extends State<ExploreNearByEventsScreen> {
  @override
