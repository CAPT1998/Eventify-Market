                  ...
                  builder: (context, orderData, child) => SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        ListView.builder(
                            itemCount: orderData.getMyEvent.invitations?.length,
                            shrinkWrap: true,
                                  ...
                                  children: [
                                    Stack(
                                      children: [
                                        ClipRRect(
                                            ...
                                            child: Image.network(
                                              "${orderData.getMyEvent.invitations![index].receiverName}",
                                              height: height * 0.2,
                                              width: width,
                                              fit: BoxFit.fill,
                                              errorBuilder:
                                    ...
                                    return AlertDialog(
                                      actions: [
                                        RoundedLoadingButton(
                                          ...
                                          onPressed: () {
                                            print('https://quickeeapi.pakwexpo.com?eventId=${orderData.getMyEvent.invitations![index].id}');
                                      ...
                                      *//*   TextButton(
                                      ...
                                      content: SizedBox(
                                        ...
                                        child: Center(child: Screenshot(
                                            ...
                                            child: QrImage(data: 'https://quickeeapi.pakwexpo.com?eventId=${orderData.getMyEvent.invitations![index].id}')),
                                      ),
                                    ));
                                  },
                                  );
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        TextWidget(
                                          title:
                                              "  ${orderData.getMyEvent.invitations![index].createdAt.toString().split(" ")[0]}",
                                          size: 12,
